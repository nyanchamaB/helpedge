...
export const siteConfig = {
  ...
  support: {
    ...
    options: [
      {
        title: 'Contact Us',
        description: 'Reach out to our support team anytime via email or phone.',
      },
      {
        title: 'FAQs',
      ...
      },
      {
        ...
        description: 'Report incidents or service requests directly from the platform.',
      },
    ],
  },
  ...
  about:
    'HelpEdge is a leading provider of ITSM solutions, dedicated to improving service management for businesses worldwide.',
};
