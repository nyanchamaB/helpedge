...
export default function MyWorkPage() {
  ...
  const filtered = useMemo(() => {
    switch (activeQueue) {
      case "assigned":   return tickets.filter((t) => t.status === "Open");
      case "inprogress": return tickets.filter((t) => t.status === "InProgress");
      case "waiting":    return tickets.filter((t) => t.status === "OnHold" || t.status === "AwaitingInfo");
