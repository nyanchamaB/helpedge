...
const CATEGORIES = ["All", "ITSM", "Automation", "Security", "Analytics", "Best Practices", "Product Updates"];
...
const POSTS: Post[] = [
  {
    ...
    excerpt: "Discover how AI-driven ticket routing, predictive analytics, and intelligent automation are cutting resolution times by up to 60% for enterprise IT teams.",
    category: "ITSM",
  ...
  },
  {
    ...
    excerpt: "Stop missing SLAs. This step-by-step guide covers policy creation, breach notifications, escalation rules, and reporting for service desks of any size.",
  ...
  },
  {
    ...
    excerpt: "Password resets, software provisioning, incident categorization — these five workflows are costing your team hours every week. Here's how to automate them.",
    category: "Automation",
    author: "Amina Hassan",
  ...
  },
  {
    ...
    excerpt: "Integrating zero trust principles into your service desk doesn't have to be painful. We break down practical steps for access control, audit trails, and compliance.",
    category: "Security",
    author: "David Wholey",
  ...
  },
  {
    ...
    excerpt: "First contact resolution, MTTR, customer satisfaction — but are you measuring the right things? We review the metrics that drive real improvement.",
    category: "Analytics",
    author: "Sarah Kennedy",
    authorRole: "Head of Product",
    date: "Jan 28, 2026",
  ...
  },
  {
    ...
    excerpt: "AI ticket categorization, redesigned dashboards, new SLA breach alerts, and 14 quality-of-life improvements are now live. Here's everything that changed.",
  ...
  },
  {
    ...
    excerpt: "A poorly maintained knowledge base is worse than none at all. Learn the structure, tagging, and maintenance habits that keep self-service working.",
    category: "Best Practices",
  ...
  },
  {
    ...
    excerpt: "Emergency changes that go wrong are costly. Use this CAB-approved checklist to assess risk, communicate changes, and roll back safely when needed.",
    category: "ITSM",
    author: "David Wholey",
    authorRole: "Security Engineer",
    date: "Jan 9, 2026",
...
const TESTIMONIALS = [
  {
    quote: "The blog content here is genuinely actionable. We implemented the SLA guide and cut our breach rate by 40% in a month.",
    author: "Rebecca Brown",
    role: "IT Director, FinServe Africa",
    initials: "RO",
  },
  {
    quote: "HelpEdge's blog keeps us ahead of the curve. The AI and automation articles alone have saved us countless hours of research.",
    author: "Tom Kassandra",
    role: "CTO, BuildTech Kenya",
    initials: "TK",
  },
  {
    quote: "We share articles from this blog in our team Slack every week. It's become our go-to reference for IT service management.",
...
function BlogCard({ post, index }: { post: Post; index: number }) {
  ...
  return (
    ...
    >
      {/* Tag */}
      {post.tag && (
        <span className={`absolute top-4 right-4 text-[10px] font-bold px-2 py-0.5 rounded-full ${TAG_COLORS[post.tag]}`}>
          {post.tag}
        </span>
      )}

      {/* Category */}
      <span className={`text-xs font-semibold px-2.5 py-1 rounded-full w-fit mb-4 ${CATEGORY_COLORS[post.category]}`}>
        {post.category}
      </span>
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-2xl">
        ...
        <p className="text-blue-100 leading-relaxed mb-8 text-sm md:text-base">
          {post.excerpt}
        </p>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-blue-200">{post.date} · {post.readTime}</p>
            </div>
          </div>
          <Link
  ...
  return (
    ...
    >
      ...
      <p className="text-muted-foreground text-sm mb-6 max-w-md mx-auto">
        Get the latest ITSM insights, product updates, and best practices delivered to your inbox every week. No spam, ever.
      </p>
      {submitted ? (
      ...
      <p className="text-xs text-muted-foreground mt-3">Join 4,200+ IT professionals. Unsubscribe anytime.</p>
    </div>
  );
}
    ...
    <main className="max-w-6xl mx-auto px-6 py-16 space-y-16">
      ...
      <div className="text-center space-y-4">
        <span className="text-xs font-semibold uppercase tracking-widest text-blue-600">
          <img 
          src={siteConfig.logo}
          className="h-15 inline-block mr-1" />
        </span>
        <h1 className="text-4xl md:text-5xl font-bold tracking-tight">
          Insights for modern IT teams
        </h1>
        <p className="text-muted-foreground text-lg max-w-xl mx-auto">
          Practical guides, product updates, and ITSM best practices from the people building HelpEdge.
        </p>
      </div>
