...
export default function EbooksPage() {
  ...
  const filteredEbooks =
    activeFilter === 'All' ? ebooks : ebooks.filter((ebook) => ebook.type === activeFilter);

  const searchedEbooks = filteredEbooks.filter(
    (ebook) =>
          ...
          <div className="relative max-w-7xl mx-auto px-6 text-center">
            ...
            >
              ...
              <p className="text-xl lg:text-2xl text-blue-100 mb-8 max-w-3xl mx-auto leading-relaxed">
                Discover expert guides, research reports, and practical resources to master IT
                Service Management
              </p>
                    ...
                    <div className="flex items-start justify-between mb-4">
                      ...
                      >
                        <Heart
                          size={18}
                          className={
                            favorites.has(ebook.id) ? 'text-red-500 fill-current' : 'text-gray-400'
                          }
                        />
                      </button>
                    </div>
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          >
                            <Heart
                              size={16}
                              className={
                                favorites.has(ebook.id)
                                  ? 'text-red-500 fill-current'
                                  : 'text-gray-400'
                              }
                            />
                          </button>
                          {ebook.premium && <Lock size={16} className="text-yellow-600" />}
                        </div>
                      </div>
                    ...
                    <div className="flex items-start justify-between mb-4">
                      ...
                      >
                        <Heart
                          size={24}
                          className={
                            favorites.has(selectedEbook.id)
        ...
        <section className="py-16 bg-gradient-to-r from-blue-600 to-purple-700">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <m.div
              ...
              transition={{ duration: 0.6 }}
            >
              <h2 className="text-3xl font-bold text-white mb-4">Stay Ahead in ITSM</h2>
