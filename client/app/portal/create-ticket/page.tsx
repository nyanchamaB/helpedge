...
import { UserTicketForm, UserTicketSubmitData } from '@/components/portal/UserTicketForm';
...
export default function PortalCreateTicket() {
  ...
  async function handleSubmit(data: UserTicketSubmitData) {
    ...
    try {
      ...
      if (ticket.triageStatus === 'AutoAssigned') {
        ...
        toast.success("Ticket submitted! We'll get back to you as soon as possible.");
      }
  ...
  return (
    <div className="container max-w-2xl mx-auto py-6 space-y-4">
      ...
      <UserTicketForm categories={categories} onSubmit={handleSubmit} isSubmitting={isSubmitting} />
    </div>
  );
}
