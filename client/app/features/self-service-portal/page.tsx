        ...
        <div className="p-6 space-y-5">
          ...
          <div className="rounded-xl border border-blue-200 dark:border-blue-900 bg-blue-50 dark:bg-blue-950/40 p-3">
            ...
            <p className="text-xs text-muted-foreground mt-0.5">
              Resolves in ~2 minutes · 94% found this helpful
            </p>
          </div>
          ...
          <div className="grid grid-cols-3 gap-2">
            {[
              ...
              <button
                key={a.label}
                className="flex flex-col items-center gap-1.5 rounded-xl border border-border bg-muted/40 p-3 hover:border-blue-400 hover:bg-blue-50 dark:hover:bg-blue-950/40 transition-colors group"
              >
                <span className="text-muted-foreground group-hover:text-blue-600 transition-colors">
                  {a.icon}
                </span>
                <span className="text-[10px] font-medium text-muted-foreground group-hover:text-blue-600 transition-colors">
                  {a.label}
                </span>
              </button>
            ))}
...
const HIGHLIGHTS = [
  {
    ...
    title: '1,200+ employees onboarded',
    sub: 'Savanna Financial — Day 1',
  },
  {
    icon: <Zap className="w-5 h-5 text-amber-500" />,
    title: 'Auto-resolved in 47 seconds',
    sub: 'Password reset via automation',
  },
  {
    icon: <CheckCircle2 className="w-5 h-5 text-emerald-500" />,
    title: '4.9 / 5 satisfaction score',
    sub: 'Q1 2026 · 2,400 responses',
  },
  {
    icon: <BarChart2 className="w-5 h-5 text-violet-500" />,
    title: '68% fewer tickets logged',
    sub: '3 months post-deployment',
  },
];
        ...
        <section className="relative max-w-7xl mx-auto px-6 pt-20 pb-24 grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative space-y-6">
            ...
            <h1 className="text-4xl md:text-5xl font-black leading-tight tracking-tight">
              IT help that doesn&rsquo;t
              <br />
              <span className="text-blue-600">need an agent.</span>
            </h1>

            <p className="text-muted-foreground text-lg leading-relaxed max-w-md">
              Give employees a branded, intelligent portal where they can submit requests, find
              answers, and track progress — without ever contacting the service desk.
            </p>
        ...
        <section className="max-w-7xl mx-auto px-6 py-24">
          <div className="text-center mb-14">
            <h2 className="text-3xl md:text-4xl font-black mb-3">
              Everything employees need. Nothing they don&rsquo;t.
            </h2>
            <p className="text-muted-foreground max-w-xl mx-auto">
              A focused, powerful set of tools that makes self-service actually work — not just
              exist.
            </p>
          </div>
          ...
          <div className="relative rounded-3xl bg-gradient-to-br from-blue-600 to-blue-800 px-8 md:px-16 py-16 text-white overflow-hidden text-center">
            ...
            <div className="relative z-10 max-w-xl mx-auto">
              <h2 className="text-3xl md:text-4xl font-black mb-4">
                Ready to deflect 68% of your tickets?
              </h2>
