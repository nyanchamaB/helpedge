      ...
      <main className="flex flex-col w-full bg-white">
        ...
        <section className="py-32 px-6 bg-gradient-to-b from-white to-blue-50">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              End-to-end IT Service Management platform designed to optimize workflows, reduce
              costs, and enhance service quality across your organization.
            </p>
          </m.div>
            ...
            {[
              {
                ...
                features: ['Incident Management', 'Problem Resolution', 'Change Control'],
              },
              {
                ...
                features: ['Workflow Automation', 'Self-Service Portal', 'AI Chatbots'],
              },
              {
        ...
        <section className="py-32 px-6 bg-white">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
              Organizations using HelpEdge ITSM experience significant improvements in service
        ...
        <section className="py-32 px-6 bg-gray-50">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
              See how enterprises are transforming their IT service management with HelpEdge.
            </p>
          </m.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10 max-w-7xl mx-auto">
            {[
              {
                quote:
                  'HelpEdge reduced our mean time to resolution by 95% and transformed our IT support operations.',
              ...
              {
                quote:
                  'The automation capabilities helped us scale our IT services across 15 countries seamlessly.',
              ...
              {
                quote:
                  'Implementation was smooth and the ROI was evident within the first quarter of use.',
              ...
              >
                ...
                <p className="italic text-lg text-gray-700 mb-6 leading-relaxed">{story.quote}</p>
                <div className="border-t pt-4">
                  <span className="block font-semibold text-blue-900 text-lg">{story.company}</span>
        ...
        <section className="py-32 px-6 bg-white">
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-4xl mx-auto">
                From traditional IT support to modern AI-driven service management - understand the
                journey.
              </p>
            </m.div>
        ...
        <section className="relative py-28 px-6 text-center overflow-hidden">
          ...
          >
            ...
            <p className="text-xl mb-10 max-w-2xl mx-auto text-blue-100">
              Join thousands of organizations using HelpEdge to modernize their IT service
              management.
            </p>
