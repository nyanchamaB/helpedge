...
const statusStyle: Record<TicketStatusString, string> = {
  ...
  InProgress: "bg-yellow-100 text-yellow-700 border-yellow-100 dark:bg-yellow-900/30 dark:text-yellow-300 dark:border-yellow-800",
  Resolved: "bg-green-100 text-green-700 border-green-100 dark:bg-green-900/30 dark:text-green-300 dark:border-green-800",
  Closed: "bg-gray-100 text-gray-600 border-gray-100 dark:bg-gray-800/50 dark:text-gray-400 dark:border-gray-700",
  OnHold: "bg-purple-100 text-purple-700 border-purple-100 dark:bg-purple-900/30 dark:text-purple-300 dark:border-purple-800",
  AwaitingInfo: "bg-teal-100 text-teal-700 border-teal-100 dark:bg-teal-900/30 dark:text-teal-300 dark:border-teal-800",
};

const priorityStyle: Record<string, string> = {
  Critical: "bg-red-100 text-red-700 border-red-100 dark:bg-red-900/30 dark:text-red-300 dark:border-red-800",
  High: "bg-orange-100 text-orange-700 border-orange-100 dark:bg-orange-900/30 dark:text-orange-300 dark:border-orange-800",
  Medium: "bg-blue-100 text-blue-600 border-blue-100 dark:bg-blue-900/30 dark:text-blue-300 dark:border-blue-800",
