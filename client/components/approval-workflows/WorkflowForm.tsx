...
const requestTypeEnum = z.enum(
  SERVICE_REQUEST_TYPES as [
    (typeof SERVICE_REQUEST_TYPES)[number],
    ...typeof SERVICE_REQUEST_TYPES,
  ],
);
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="e.g., Standard Software Access Approval" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea placeholder="Describe when this workflow applies..." {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
              ...
              render={() => (
                <FormItem>
                  ...
                  <div className="flex flex-wrap gap-2 mt-1">
                    ...
                    {categories.length === 0 && (
                      <p className="text-sm text-muted-foreground italic">No active categories</p>
                    )}
                  </div>
                  <FormMessage />
                </FormItem>
            ...
            {fields.map((field, index) => (
              <div key={field.id} className="border rounded-lg p-4 space-y-4 bg-muted/30">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="e.g., Team Lead Approval" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                ...
                {form.watch(`steps.${index}.approverType`) === 'Role' && (
                  <FormField
                    control={form.control}
                    name={`steps.${index}.approverRoles`}
                    render={() => (
                      <FormItem>
                        ...
                        <div className="flex flex-wrap gap-2 mt-1">
                          {STAFF_ROLES.map((role) => {
                            const selected = (
                              form.watch(`steps.${index}.approverRoles`) ?? []
                            ).includes(role);
                ...
                <div className="flex flex-wrap gap-6">
                    ...
                    render={({ field }) => (
                      <FormItem className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <FormDescription className="text-xs">
                            Approver can assign to someone else
                          </FormDescription>
                        </div>
                      </FormItem>
                    )}
                  ...
                  <FormField
                    control={form.control}
                    name={`steps.${index}.autoApproveOnTimeout`}
                    render={({ field }) => (
                      <FormItem className="flex items-center gap-3">
                        <FormControl>
                          <Switch checked={field.value} onCheckedChange={field.onChange} />
                        ...
                        <div>
                          ...
                          <FormDescription className="text-xs">
                            Automatically approve if timeout is reached
                          </FormDescription>
                        </div>
                      </FormItem>
                    )}
