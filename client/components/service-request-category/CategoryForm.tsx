...
const requestTypeOptions = SERVICE_REQUEST_TYPES.map((t) => ({
  value: t,
  label: getSRTypeLabel(t),
}));
    ...
    defaultValues: initialData
      ? {
          ...
          requiredFields: (initialData.requiredFields ??
            []) as CategoryFormValues['requiredFields'],
      ...
      <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-8">
                          ...
                          <div className="grid grid-cols-7 gap-1">
                            {PRESET_ICONS.map((icon) => (
                              ...
                              >
                                <CategoryIcon
                                  icon={icon}
                                  color={field.value === icon ? form.watch('color') : undefined}
                                />
                              </button>
                            ))}
                          </div>
                      ...
                      <PopoverContent className="w-64">
                        <div className="space-y-4">
                          ...
                          <p className="text-xs text-muted-foreground">
                            Click a color to select, or type a hex value
                          </p>
                        </div>
                      </PopoverContent>
                    </Popover>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Keywords help users and the AI find this category when searching
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Additional fields to collect when users submit requests in this category
            </CardDescription>
          </CardHeader>
          <CardContent>
              ...
              {fields.map((field, index) => (
                <div key={field.id} className="border rounded-lg p-6 space-y-4 bg-muted/20">
                  ...
                  {OPTION_FIELD_TYPES.includes(
                    form.watch(`requiredFields.${index}.type`) as FieldType,
                  ) && (
                    <div className="space-y-3 p-4 bg-background rounded-lg border">
                      ...
                      <div className="flex space-x-2">
                        <Input
                          ...
                          onChange={(e) =>
                            setOptionsInput((prev) => ({ ...prev, [index]: e.target.value }))
                          }
                          onKeyDown={(e) =>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {(form.watch(`requiredFields.${index}.options`) || []).map(
                          (option, optIndex) => (
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            placeholder="Hint shown to users below the field..."
                            {...field}
                            value={field.value || ''}
                          />
                        </FormControl>
